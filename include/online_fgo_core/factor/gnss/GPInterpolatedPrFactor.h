...
#ifndef ONLINE_FGO_GPINTERPOLATEDPRFACTOR_H
#define ONLINE_FGO_GPINTERPOLATEDPRFACTOR_H
#pragma once
...
namespace fgo::factor {
  ...
  class GPInterpolatedPrFactor : public NoiseModelFactor7<gtsam::Pose3, gtsam::Vector3, gtsam::Vector3,
  ...
  private:
    ...
    typedef GPInterpolatedPrFactor This;
  ...
  public:
    ...
    GPInterpolatedPrFactor() = default; /* Default constructor */

    /**
     * Constructor
     * @param body_P_sensor transformation from body to sensor
     */
    GPInterpolatedPrFactor(gtsam::Key pose_i, gtsam::Key vel_i, gtsam::Key omega_i,
    ...
    void print(const std::string &s = "",
      ...
      std::cout << s << "GPInterpolatedPrFactor" << std::endl;
  ...
  private:
    ...
    void serialize(ARCHIVE &ar, const unsigned int version) {
      ar & boost::serialization::make_nvp("GPInterpolatedPrFactor",
