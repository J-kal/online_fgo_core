...
namespace fgo::factor {
  ...
  class GPInterpolatedNavAttitudeFactor
  ...
  public:
    ...
    GPInterpolatedNavAttitudeFactor(gtsam::Key poseKeyI, gtsam::Key velKeyI, gtsam::Key omegaKeyI,
      ...
      Base(model, poseKeyI, velKeyI, omegaKeyI, poseKeyJ, velKeyJ, omegaKeyJ), rotMeasured_(rotMeasured),
      measuredRotFrame_(rotFrame),
      ...
      if (useAutoDiff_) {
        ...
        switch (measuredRotFrame_) {
          ...
          case MeasurementFrame::ENU: {
            ...
            error = gtsam::Rot3::Logmap(rotNav.between(rotMeasured_, (H1 || H4) ? &D_dR_R : nullptr),
                                        (H1 || H4) ? &D_xi_R : nullptr);
            if (H1 || H2 || H3 || H4 || H5 || H6) {
          ...
          default: {
            error = gtsam::Rot3::Logmap(rot.between(rotMeasured_, (H1 || H4) ? &D_dR_R : nullptr),
                                        (H1 || H4) ? &D_xi_R : nullptr);
            if (H1 || H2 || H3 || H4 || H5 || H6) {
