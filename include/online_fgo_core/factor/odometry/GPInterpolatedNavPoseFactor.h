...
namespace fgo::factor {
  ...
  public:
    ...
    GPInterpolatedNavPoseFactor(gtsam::Key poseKeyI, gtsam::Key velKeyI, gtsam::Key omegaKeyI,
      ...
      Base(model, poseKeyI, velKeyI, omegaKeyI, poseKeyJ, velKeyJ, omegaKeyJ), poseMeasured_(poseMeasured),
      ...
      if (useAutoDiff_) {
        if (H1)
          *H1 = gtsam::numericalDerivative11<gtsam::Vector6, gtsam::Pose3>(
            boost::bind(&This::evaluateError_, this, boost::placeholders::_1, velI, omegaI, poseJ, velJ, omegaJ), poseI,
            1e-5);

        if (H2)
          *H2 = gtsam::numericalDerivative11<gtsam::Vector6, gtsam::Vector3>(
            boost::bind(&This::evaluateError_, this, poseI, boost::placeholders::_1, omegaI, poseJ, velJ, omegaJ), velI,
            1e-5);

        if (H3)
          *H3 = gtsam::numericalDerivative11<gtsam::Vector6, gtsam::Vector3>(
            boost::bind(&This::evaluateError_, this, poseI, velI, boost::placeholders::_1, poseJ, velJ, omegaJ), omegaI,
            1e-5);

        if (H4)
          *H4 = gtsam::numericalDerivative11<gtsam::Vector6, gtsam::Pose3>(
            boost::bind(&This::evaluateError_, this, poseI, velI, omegaI, boost::placeholders::_1, velJ, omegaJ), poseJ,
            1e-5);

        if (H5)
          *H5 = gtsam::numericalDerivative11<gtsam::Vector6, gtsam::Vector3>(
            boost::bind(&This::evaluateError_, this, poseI, velI, omegaI, poseJ, boost::placeholders::_1, omegaJ), velJ,
            1e-5);

        if (H6)
          *H6 = gtsam::numericalDerivative11<gtsam::Vector6, gtsam::Vector3>(
            boost::bind(&This::evaluateError_, this, poseI, velI, omegaI, poseJ, velJ, boost::placeholders::_1), omegaJ,
            1e-5);
