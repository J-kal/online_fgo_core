...
#ifndef ONLINE_FGO_FACTORTYPE_H
#define ONLINE_FGO_FACTORTYPE_H
...
namespace fgo {
  ...
  template<class VALUE1, class VALUE2, class VALUE3, class VALUE4,
    ...
    class VALUE17, class VALUE18, class VALUE19, class VALUE20>
  class NoiseModelFactor20 : public gtsam::NoiseModelFactor {
  public:
  ...
  protected:
    ...
    typedef NoiseModelFactor20<VALUE1, VALUE2, VALUE3, VALUE4,
      VALUE5, VALUE6, VALUE7, VALUE8,
      VALUE9, VALUE10, VALUE11, VALUE12,
      VALUE13, VALUE14, VALUE15, VALUE16,
      VALUE17, VALUE18, VALUE19, VALUE20> This;
  ...
  public:
     ...
     */
    NoiseModelFactor20() = default;

    /**
     * Constructor
     * @param noiseModel shared pointer to noise model
     * @param j1 - j20 key of the first variable
     */
    NoiseModelFactor20(const gtsam::SharedNoiseModel &noiseModel,
                       gtsam::Key j1, gtsam::Key j2, gtsam::Key j3, gtsam::Key j4,
                       gtsam::Key j5, gtsam::Key j6, gtsam::Key j7, gtsam::Key j8,
                       gtsam::Key j9, gtsam::Key j10, gtsam::Key j11, gtsam::Key j12,
                       gtsam::Key j13, gtsam::Key j14, gtsam::Key j15, gtsam::Key j16,
                       gtsam::Key j17, gtsam::Key j18, gtsam::Key j19, gtsam::Key j20) :
      Base(noiseModel, gtsam::KeyVector{j1, j2, j3, j4, j5, j6, j7, j8, j9, j10,
                                        j11, j12, j13, j14, j15, j16, j17, j18, j19, j20}) {}

    ~NoiseModelFactor20() override = default;
    ...
    [[nodiscard]] inline gtsam::Key key17() const { return keys_[16]; }

    [[nodiscard]] inline gtsam::Key key18() const { return keys_[17]; }

    [[nodiscard]] inline gtsam::Key key19() const { return keys_[18]; }

    [[nodiscard]] inline gtsam::Key key20() const { return keys_[19]; }
      ...
      if (this->active(x)) {
        if (H)
          return evaluateError(x.at<X1>(keys_[0]), x.at<X2>(keys_[1]), x.at<X3>(keys_[2]), x.at<X4>(keys_[3]),
                               ...
                               x.at<X17>(keys_[16]), x.at<X18>(keys_[17]), x.at<X19>(keys_[18]), x.at<X20>(keys_[19]),
                               (*H)[0], (*H)[1], (*H)[2], (*H)[3],
                               (*H)[4], (*H)[5], (*H)[6], (*H)[7],
                               (*H)[8], (*H)[9], (*H)[10], (*H)[11],
                               (*H)[12], (*H)[13], (*H)[14], (*H)[15],
 ...
 */
    ...
    evaluateError(const X1 &, const X2 &, const X3 &, const X4 &, const X5 &, const X6 &, const X7 &, const X8 &,
                  ...
                  boost::optional<gtsam::Matrix &> H16 = boost::none,
                  boost::optional<gtsam::Matrix &> H17 = boost::none,
                  boost::optional<gtsam::Matrix &> H18 = boost::none,
                  boost::optional<gtsam::Matrix &> H19 = boost::none,
                  boost::optional<gtsam::Matrix &> H120 = boost::none) const = 0;
  ...
  public:
     ...
     */
    NoiseModelFactor16(const gtsam::SharedNoiseModel &noiseModel, gtsam::Key j1, gtsam::Key j2, gtsam::Key j3,
                       gtsam::Key j4,
      ...
      Base(noiseModel,
           gtsam::KeyVector{j1, j2, j3, j4, j5, j6, j7, j8, j9, j10, j11, j12, j13, j14, j15, j16}) {}
 ...
 */
  ...
  public:
     ...
     * @param j12 key of the twelfth variable
     */
    NoiseModelFactor15(const gtsam::SharedNoiseModel &noiseModel, gtsam::Key j1, gtsam::Key j2, gtsam::Key j3,
                       gtsam::Key j4,
                       gtsam::Key j5, gtsam::Key j6, gtsam::Key j7, gtsam::Key j8, gtsam::Key j9, gtsam::Key j10,
                       gtsam::Key j11,
                       gtsam::Key j12, gtsam::Key j13, gtsam::Key j14, gtsam::Key j15) :
      Base(noiseModel,
           gtsam::KeyVector{j1, j2, j3, j4, j5, j6, j7, j8, j9, j10, j11, j12, j13, j14, j15}) {}
 ...
 */
  ...
  template<class VALUE1, class VALUE2, class VALUE3, class VALUE4,
    class VALUE5, class VALUE6, class VALUE7, class VALUE8,
    class VALUE9, class VALUE10, class VALUE11, class VALUE12,class VALUE13>
  class NoiseModelFactor13 : public gtsam::NoiseModelFactor {
    // TODO: @Haoming Check this
  public:
    // typedefs for value types pulled from keys
    typedef VALUE1 X1;
    typedef VALUE2 X2;
  ...
  public:
     ...
     * @param j11 key of the eleventh variable
     * @param j12 key of the twelfth variable
     * @param j13 key of the twelfth variable
     */
    NoiseModelFactor13(const gtsam::SharedNoiseModel &noiseModel, gtsam::Key j1, gtsam::Key j2, gtsam::Key j3,
                       gtsam::Key j4,
                       gtsam::Key j5, gtsam::Key j6, gtsam::Key j7, gtsam::Key j8, gtsam::Key j9, gtsam::Key j10,
                       gtsam::Key j11,
                       gtsam::Key j12,gtsam::Key j13) :
      Base(noiseModel, gtsam::KeyVector{j1, j2, j3, j4, j5, j6, j7, j8, j9, j10, j11, j12, j13}) {}

    ~NoiseModelFactor13() override = default;
    ...
    [[nodiscard]] gtsam::Vector unwhitenedError(const gtsam::Values &x,
      ...
      if (this->active(x)) {
        if (H)
          return evaluateError(x.at<X1>(keys_[0]), x.at<X2>(keys_[1]), x.at<X3>(keys_[2]), x.at<X4>(keys_[3]),
                               x.at<X5>(keys_[4]), x.at<X6>(keys_[5]), x.at<X7>(keys_[6]), x.at<X8>(keys_[7]),
                               x.at<X9>(keys_[8]), x.at<X10>(keys_[9]), x.at<X11>(keys_[10]), x.at<X12>(keys_[11]),x.at<X13>(keys_[12]),
                               (*H)[0], (*H)[1], (*H)[2], (*H)[3],
                               (*H)[4], (*H)[5], (*H)[6], (*H)[7],
 ...
 */
    ...
    evaluateError(const X1 &, const X2 &, const X3 &, const X4 &,
                  const X5 &, const X6 &, const X7 &, const X8 &,
                  const X9 &, const X10 &, const X11 &, const X12 &,const X13&,
                  boost::optional<gtsam::Matrix &> H1 = boost::none,
                  boost::optional<gtsam::Matrix &> H2 = boost::none,
                  boost::optional<gtsam::Matrix &> H3 = boost::none,
                  boost::optional<gtsam::Matrix &> H4 = boost::none,
  ...
  public:
     ...
     * @param j12 key of the twelfth variable
     */
    NoiseModelFactor12(const gtsam::SharedNoiseModel &noiseModel, gtsam::Key j1, gtsam::Key j2, gtsam::Key j3,
                       gtsam::Key j4,
                       gtsam::Key j5, gtsam::Key j6, gtsam::Key j7, gtsam::Key j8, gtsam::Key j9, gtsam::Key j10,
                       gtsam::Key j11,
                       gtsam::Key j12) :
      Base(noiseModel, gtsam::KeyVector{j1, j2, j3, j4, j5, j6, j7, j8, j9, j10, j11, j12}) {}
 ...
 */
  ...
  public:
     ...
     * @param j11 key of the eleventh variable
     */
    NoiseModelFactor11(const gtsam::SharedNoiseModel &noiseModel, gtsam::Key j1, gtsam::Key j2, gtsam::Key j3,
                       gtsam::Key j4,
                       gtsam::Key j5, gtsam::Key j6, gtsam::Key j7, gtsam::Key j8, gtsam::Key j9, gtsam::Key j10,
                       gtsam::Key j11) :
      Base(noiseModel, gtsam::KeyVector{j1, j2, j3, j4, j5, j6, j7, j8, j9, j10, j11}) {}
 ...
 */
  ...
  public:
     ...
     * @param j11 key of the eleventh variable
     */
    NoiseModelFactor10(const gtsam::SharedNoiseModel &noiseModel, gtsam::Key j1, gtsam::Key j2, gtsam::Key j3,
                       gtsam::Key j4,
                       gtsam::Key j5, gtsam::Key j6, gtsam::Key j7, gtsam::Key j8, gtsam::Key j9, gtsam::Key j10) :
      Base(noiseModel, gtsam::KeyVector{j1, j2, j3, j4, j5, j6, j7, j8, j9, j10}) {}
 ...
 */
  ...
  public:
     ...
     */
    NoiseModelFactor9(const gtsam::SharedNoiseModel &noiseModel, gtsam::Key j1, gtsam::Key j2, gtsam::Key j3,
                      gtsam::Key j4,
                      gtsam::Key j5, gtsam::Key j6, gtsam::Key j7, gtsam::Key j8, gtsam::Key j9) :
      Base(noiseModel, gtsam::KeyVector{j1, j2, j3, j4, j5, j6, j7, j8, j9}) {}
 ...
 */
  ...
  public:
     ...
     * @param j8 key of the eighth variable
     */
    NoiseModelFactor8(const gtsam::SharedNoiseModel &noiseModel, gtsam::Key j1, gtsam::Key j2, gtsam::Key j3,
                      gtsam::Key j4,
                      gtsam::Key j5, gtsam::Key j6, gtsam::Key j7, gtsam::Key j8) :
      Base(noiseModel, gtsam::KeyVector{j1, j2, j3, j4, j5, j6, j7, j8}) {}
 ...
 */
  ...
  public:
    ...
    NoiseModelFactor7(const gtsam::SharedNoiseModel &noiseModel, gtsam::Key j1, gtsam::Key j2, gtsam::Key j3,
      ...
      Base(noiseModel, gtsam::KeyVector{j1, j2, j3, j4, j5, j6, j7}) {}
