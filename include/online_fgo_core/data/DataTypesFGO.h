...
#ifndef ONLINE_FGO_CORE_DATA_TYPES_FGO_H
#define ONLINE_FGO_CORE_DATA_TYPES_FGO_H
...
namespace fgo::data {
  ...
  struct QueryStateOutput {
    ...
    fgo::core::TimeStamp timestampCurrent;
    gtsam::Pose3 pose;
...
#endif // ONLINE_FGO_CORE_DATA_TYPES_FGO_H
