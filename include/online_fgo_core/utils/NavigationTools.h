...
namespace fgo::utils {
    ...
    inline fgo::core::TimeStamp roundTime(const fgo::core::TimeStamp& timeStamp, size_t precisionAfterSecond = 2, double offsetSecond = 0.)
    {
      auto precision = std::pow(10., precisionAfterSecond);
      auto thisTime = timeStamp.toSec();
      thisTime *= precision;
      ...
      return fgo::core::TimeStamp(thisTimeRounded / 1000000000, (thisTimeRounded % 1000000000));
    }
